    ...
    <Container fluid className="home-about-section" id="about">
      <Container>
        <Row>
          ...
          <iframe src="https://player.twitch.tv/?channel=euapatroaeascrias&parent=https://matteo-portfolio-matteothebrave.bohr.io/" frameborder="0" allowfullscreen="true" scrolling="no" height="378" width="620"></iframe>
